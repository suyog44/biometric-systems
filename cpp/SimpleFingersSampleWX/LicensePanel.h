#ifndef LISENCE_PANEL_H_INCLUDED
#define LISENCE_PANEL_H_INCLUDED
...
namespace Neurotec
{
	namespace Samples
	{
		...
		{
		public:
			LicensePanel(wxWindow *parent, wxWindowID id = wxID_ANY, const wxPoint & pos = wxDefaultPosition, const wxSize & size = wxDefaultSize,
