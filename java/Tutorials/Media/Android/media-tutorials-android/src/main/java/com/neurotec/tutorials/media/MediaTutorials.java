...
public final class MediaTutorials extends ListActivity {
	...
	public static final String CATEGORY_NEUROTEC_TUTORIAL = MediaTutorials.class.getPackage().getName() + ".CATEGORY_NEUROTEC_TUTORIAL";
