...
public final class FIRecordToNTemplate extends Activity implements LicensingStateCallback {
	...
	private void convert(Uri recordUri) throws IOException {
		...
		try {
			...
			fiRecord = new FIRecord(fiRecordData, BDIFStandard.ISO);
			...
			if (status == NBiometricStatus.OK) {
				...
				File outputFile = new File(BiometricStandardsTutorialsApp.TUTORIALS_OUTPUT_DATA_DIR, "ntemplate-from-firecord.dat");
			...
			if (fiRecord != null) fiRecord.dispose();
		}
	}
