...
public final class ANTemplateType3FromNImage extends Activity implements LicensingStateCallback {

	private static final String TAG = ANTemplateType3FromNImage.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tutorial_antemplate_type_3_from_nimage);
	...
	private void convert(Uri imageUri) throws IOException {
		...
		try {
			...
			ANType3Record record = new ANType3Record(ANTemplate.VERSION_CURRENT, 0, true, ANImageCompressionAlgorithm.NONE, image, 0);
			...
			File outputFile = new File(BiometricStandardsTutorialsApp.TUTORIALS_OUTPUT_DATA_DIR, "antemplate-type-3.dat");
			NFile.writeAllBytes(outputFile.getAbsolutePath(), template.save());

			showMessage(getString(R.string.format_antemplate_saved_to, 3, outputFile.getAbsolutePath()));
		} finally {
