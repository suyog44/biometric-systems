...
public final class ANTemplateType5FromNImage extends Activity implements LicensingStateCallback {

	private static final String TAG = ANTemplateType5FromNImage.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tutorial_antemplate_type_5_from_nimage);
	...
	private void convert(Uri imageUri) throws IOException {
		...
		try {
			...
			ANType5Record record = new ANType5Record(ANTemplate.VERSION_CURRENT, 0, true, ANBinaryImageCompressionAlgorithm.NONE, image);
			...
			File outputFile = new File(BiometricStandardsTutorialsApp.TUTORIALS_OUTPUT_DATA_DIR, "antemplate-type-5.dat");
			NFile.writeAllBytes(outputFile.getAbsolutePath(), template.save());

			showMessage(getString(R.string.format_antemplate_saved_to, 5, outputFile.getAbsolutePath()));
		} finally {
