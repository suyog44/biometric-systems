...
public final class ANTemplateType16FromNImage {
	...
	private static void usage() {
		...
		System.out.format("\t%s [NImage] [ANTemplate] [Tot] [Dai] [Ori] [Tcn] [Src] [Udi]%n", NAME);
		System.out.println("");
	...
	public static void main(String[] args) {
		...
		final String components = "Biometrics.Standards.Base";
		...
		try {
			...
			ANType16Record record = new ANType16Record(ANTemplate.VERSION_CURRENT, 0, udi, src, BDIFScaleUnits.NONE, ANImageCompressionAlgorithm.NONE, rgbImage);
