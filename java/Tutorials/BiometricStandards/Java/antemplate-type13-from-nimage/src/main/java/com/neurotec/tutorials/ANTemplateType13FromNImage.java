...
public final class ANTemplateType13FromNImage {

	private static final String DESCRIPTION = "Demonstrates creation of ANTemplate with type 13 record in it.";
	private static final String NAME = "antemplate-type13-from-nimage";
	...
	public static void main(String[] args) {
		...
		try {
			...
			ANType13Record record = new ANType13Record(ANTemplate.VERSION_CURRENT, 0, BDIFFPImpressionType.LIVE_SCAN_PLAIN, src, BDIFScaleUnits.PIXELS_PER_INCH, ANImageCompressionAlgorithm.NONE, hrGrayImage);
