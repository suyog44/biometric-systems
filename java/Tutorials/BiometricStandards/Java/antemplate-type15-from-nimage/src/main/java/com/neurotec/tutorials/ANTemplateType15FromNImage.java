...
public final class ANTemplateType15FromNImage {

	private static final String DESCRIPTION = "Demonstrates creation of ANTemplate with type 15 record in it.";
	private static final String NAME = "antemplate-type15-from-nimage";
	...
	public static void main(String[] args) {
		...
		final String components = "Biometrics.Standards.Palms";
		...
		try {
			...
			ANType15Record record = new ANType15Record(ANTemplate.VERSION_CURRENT, 0, src, BDIFScaleUnits.PIXELS_PER_INCH, ANImageCompressionAlgorithm.NONE, hrGrayImage);
