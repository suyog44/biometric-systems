		...
		static int Main(string[] args)
		{
			...
			try
			{
				...
				using (NImage hrGrayImage = NImage.FromImage(NPixelFormat.Grayscale8U, 0, image))
				{
					...
					var record = new ANType13Record(ANTemplate.VersionCurrent, 0, BdifFPImpressionType.LiveScanPlain, src, BdifScaleUnits.PixelsPerInch, ANImageCompressionAlgorithm.None, hrGrayImage);
