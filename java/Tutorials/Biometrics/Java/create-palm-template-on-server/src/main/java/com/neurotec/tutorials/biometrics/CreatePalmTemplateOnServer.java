...
public final class CreatePalmTemplateOnServer {
	private static final String DESCRIPTION = "Demonstrates how to create palm template from image on server";
	private static final String NAME = "create-palm-template-on-server";
	...
	public static void main(String[] args) {
		...
		try {
			...
			palm.setSampleBuffer(NFile.readAllBytes(parseArgsResult.imageFile));
