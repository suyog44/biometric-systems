...
public final class GeneralizePalm {
	private static final String DESCRIPTION = "Demonstrates template creation and generalization of multiple palms";
	private static final String NAME = "generalize-palm";
	private static final String VERSION = "9.0.0.0";

	private static void usage() {
		System.out.println("usage:");
		System.out.format("%s [output template] [3 to 10 palm images]%n", NAME);
		System.out.format("\texample %s template image1.png image2.png image3.png%n", NAME);
		System.out.println();
	}

	public static void main(String[] args) {
		String components = "Biometrics.PalmExtraction";
