...
public final class IdentifyPalm {
	private static final String DESCRIPTION = "Demonstrates palm identification";
	private static final String NAME = "indentify-palm";
