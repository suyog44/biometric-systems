...
public final class VerifyFinger {

    private static final String DESCRIPTION = "Demonstrates verification of two finger images";
    private static final String NAME = "verify-finger";
    ...
    public static void main(String[] args) {
        final String components = "Biometrics.FingerExtraction,Biometrics.FingerMatching";
    ...
    static NSubject createSubject(String fileName, String subjectId) {
