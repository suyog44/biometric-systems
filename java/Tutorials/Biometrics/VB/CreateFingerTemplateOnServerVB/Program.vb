...
Namespace Neurotec.Biometrics
	Friend NotInheritable Class Program
		...
		Private Shared Function Usage() As Integer
			...
			Console.WriteLine(Constants.vbTab & "-i [image]   - image filename to store finger image.")
			Console.WriteLine(Constants.vbTab & "-t [output template]   - filename to store finger template.")
			Return 1
		End Function
				...
				Using biometricClient = New NBiometricClient()
					Using subject = New NSubject()
						Using finger = New NFinger()
							...
							finger.SampleBuffer = New NBuffer(File.ReadAllBytes(imageFile))
