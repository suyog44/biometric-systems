...
Namespace Neurotec.Biometrics
	Friend NotInheritable Class Program
		...
		Private Shared Function Usage() As Integer
			...
			Console.WriteLine(Constants.vbTab & "-i [image]   - image filename to store palm image.")
			Console.WriteLine(Constants.vbTab & "-t [output template]   - filename to store palm template.")
			Return 1
		End Function
