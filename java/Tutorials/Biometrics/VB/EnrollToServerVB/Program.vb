...
Friend Class Program
	...
	Private Shared Function Usage() As Integer
		...
		Console.WriteLine(Constants.vbTab & "-t template      - template to be sent for enrollment (required)")
		...
		Try
			Using biometricClient = New NBiometricClient()
				...
				Using subject As NSubject = CreateSubject(templateFile, templateFile)
					...
					Dim connection = New NClusterBiometricConnection With {.Host = server, .AdminPort = port}
