...
Namespace Neurotec.Biometrics
	Friend NotInheritable Class Program
		...
		Private Shared Function Usage() As Integer
			...
			Console.WriteLine(Constants.vbTab & "-v [voice record]   -filename of voice record.")
			Console.WriteLine(Constants.vbTab & "-t [output template]   - filename to store voice template.")
			Return 1
		End Function
		...
		Shared Function Main(ByVal args() As String) As Integer
			...
			Dim voiceFile As String = "voice.mp3"
			Try
				ParseArgs(args, server, adminPort, voiceFile, templateFile)
		...
		Private Shared Sub ParseArgs(ByVal args() As String, <System.Runtime.InteropServices.Out()> ByRef serverIp As String, <System.Runtime.InteropServices.Out()> ByRef adminPort As Integer, <System.Runtime.InteropServices.Out()> ByRef voiceFile As String, <System.Runtime.InteropServices.Out()> ByRef templateFile As String)
			...
			If voiceFile = String.Empty Then
