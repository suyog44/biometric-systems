...
Namespace Neurotec.Biometrics
	Friend NotInheritable Class Program
		...
		Private Shared Function Usage() As Integer
			...
			Console.WriteLine(Constants.vbTab & "-i [image]   - image filename to store face image.")
			Console.WriteLine(Constants.vbTab & "-t [output template]   - filename to store face template.")
			Return 1
		End Function
				...
				Using biometricClient = New NBiometricClient()
					Using subject = New NSubject()
						Using face = New NFace()
							...
							face.SampleBuffer = New NBuffer(File.ReadAllBytes(imageFile))
