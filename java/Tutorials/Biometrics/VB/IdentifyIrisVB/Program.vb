...
Friend Class Program
	Private Shared Function Usage() As Integer
		...
		Console.WriteLine(Constants.vbTab & "{0} [probe image] [gallery image list]...", TutorialUtils.GetAssemblyName())
		Console.WriteLine()
	...
	Shared Function Main(ByVal args() As String) As Integer
		Const Components As String = "Biometrics.IrisExtraction,Biometrics.IrisMatching"
		...
		Try
			...
			Using biometricClient = New NBiometricClient()
				Using probeSubject As NSubject = CreateSubject(args(0), "ProbeSubject")	' Create probe template
	...
	Private Shared Function CreateSubject(ByVal fileName As String, ByVal subjectId As String) As NSubject
		...
		Dim iris = New NIris With {.FileName = fileName}
