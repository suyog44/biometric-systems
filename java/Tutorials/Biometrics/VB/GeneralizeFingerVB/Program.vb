...
Friend Class Program
	Private Shared Function Usage() As Integer
		...
		Console.WriteLine(Constants.vbTab & "{0} [output template] [3 to 10 finger images]", TutorialUtils.GetAssemblyName())
			...
			Using biometricClient As New NBiometricClient()
				Using subject As New NSubject()
					For i As Integer = 1 To args.Length - 1
						Dim finger As NFinger = New NFinger With {.SessionId = 1, .FileName = args(i)}
