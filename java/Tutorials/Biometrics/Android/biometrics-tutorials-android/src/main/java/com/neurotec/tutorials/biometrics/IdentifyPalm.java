...
public final class IdentifyPalm extends BaseActivity implements LicensingManager.LicensingStateCallback {

	private static final String TAG = IdentifyPalm.class.getSimpleName();
	private static final int REQUEST_CODE_GET_CANDIDATE = 1;
	private static final int REQUEST_CODE_GET_PROBE = 2;

	private static final String[] LICENSES = { LicensingManager.LICENSE_PALM_MATCHING, LicensingManager.LICENSE_PALM_MATCHING_FAST, LicensingManager.LICENSE_PALM_EXTRACTION };
	...
	private void init() {
		...
		mBiometricClient.setPalmsMatchingSpeed(NMatchingSpeed.LOW);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tutorial_identify_palm);
