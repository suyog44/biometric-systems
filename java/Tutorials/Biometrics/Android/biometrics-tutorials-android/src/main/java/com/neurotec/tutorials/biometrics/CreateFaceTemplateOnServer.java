...
public final class CreateFaceTemplateOnServer extends BaseActivity {
	...
	private static final String TAG = CreateFaceTemplateOnServer.class.getSimpleName();
	...
	private void enroll(Uri imageUri) throws IOException {
		...
		try {
			...
			if (status == NBiometricStatus.OK) {
				...
				File outputFile = new File(BiometricsTutorialsApp.TUTORIALS_OUTPUT_DATA_DIR, "create-face-template-on-server.dat");
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tutorial_face_template_on_server);
