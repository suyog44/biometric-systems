...
public class IdentifyVoice extends BaseActivity implements LicensingManager.LicensingStateCallback  {

	private static final String TAG = IdentifyVoice.class.getSimpleName();
	private static final int REQUEST_CODE_GET_CANDIDATE = 1;
	private static final int REQUEST_CODE_GET_PROBE = 2;

	private static final String[] LICENSES = { LicensingManager.LICENSE_VOICE_MATCHING, LicensingManager.LICENSE_VOICE_MATCHING_FAST, LicensingManager.LICENSE_VOICE_EXTRACTION };
		...
		runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				case OBTAINING:
					...
					mProgressDialog = ProgressDialog.show(IdentifyVoice.this, "", getString(R.string.msg_obtaining_licenses));
					break;
				case OBTAINED:
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tutorial_identify_voice);
		mButtonCandidate = (Button) findViewById(R.id.tutorials_button_1);
		mButtonCandidate.setText(R.string.msg_select_candidate_templates);
		...
		mButtonProbe.setText(R.string.msg_select_probe_voice);
	...
	private NSubject createSubject(Uri uri) throws IOException {
		...
		voice.setSoundBuffer(NSoundBufferUtils.fromUri(this, uri));
