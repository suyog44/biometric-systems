...
public final class IdentifyIris extends BaseActivity implements LicensingManager.LicensingStateCallback {

	private static final String TAG = IdentifyIris.class.getSimpleName();
	...
	private void init() {
		...
		mBiometricClient.setIrisesMatchingSpeed(NMatchingSpeed.LOW);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tutorial_identify_iris);
		...
		mButtonCandidate.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				getImageTemplate(REQUEST_CODE_GET_CANDIDATE);
			}
		});
		...
		mButtonProbe.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				getImageTemplate(REQUEST_CODE_GET_PROBE);
			}
		});
	...
	private void getImageTemplate(int requestCode) {
	...
	private NSubject createSubject(Uri uri) throws IOException {
		...
		iris.setImage(NImageUtils.fromUri(this, uri));
