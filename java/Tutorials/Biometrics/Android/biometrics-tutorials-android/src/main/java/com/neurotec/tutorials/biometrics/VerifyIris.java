...
public final class VerifyIris extends Activity implements LicensingStateCallback {

	private static final String TAG = VerifyIris.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tutorial_verify_iris);
	...
	private void verify() throws IOException {
		if (!LicensingManager.isIrisMatchingActivated()) {
			showMessage(getString(R.string.format_not_activated, LicensingManager.LICENSE_IRIS_MATCHING));
