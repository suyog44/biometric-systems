...
const NChar title[] = N_T("IdentifyIris");
const NChar description[] = N_T("Demonstrates iris identification.");
...
{
	cout << "usage:" << endl;
	cout << "\t" << title << " [probe image] [list of gallery images] ..." << endl;
	return 1;
}
...
int main(int argc, NChar * * argv)
{
	...
	try
	{
		...
		{
			enrollTask.GetSubjects().Add(CreateSubject(argv[i+1], NString::Format ("GallerySubject {I}", i)));
		}
