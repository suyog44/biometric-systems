...
public final class FMRecordSample implements PropertyChangeListener {
	...
	public static void main(String[] args) {
		...
		FMRecordSample sample = new FMRecordSample();
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					frame.setTitle("FMRecord Editor");
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (LicenseManager.PROGRESS_CHANGED_PROPERTY.equals(evt
				.getPropertyName())) {
