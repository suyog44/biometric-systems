...
#Region "Windows Form Designer generated code"
	...
	Private Sub InitializeComponent()
		...
		'pluginComboBox
		'
		Me.pluginComboBox.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
...
#End Region
	...
	Public Sub FilterDevicePlugin(ByVal plugin As NPlugin)
		'foreach (var item in pluginComboBox.Items)
		'{
		'    NPlugin iPlugin = item as NPlugin;
		'    if (!plugin.Equals(iPlugin))
		'    {
		'        pluginCom
		'    }
		'}
		For i As Integer = pluginComboBox.Items.Count - 1 To 0 Step -1
			If (Not plugin.ToString().Equals(pluginComboBox.Items(i))) Then
				pluginComboBox.Items.RemoveAt(i)
			End If
		Next i
	End Sub
