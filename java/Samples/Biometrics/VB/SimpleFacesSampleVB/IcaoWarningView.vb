...
#Region "Private methods"
	...
	Private Sub OnAttributesAdded(ByVal s As Object, ByVal a As NLAttributes)
		If Object.Equals((CType(s, NFace.ObjectCollection)).Owner, _face) Then
			If _attributes IsNot Nothing Then
				RemoveHandler _attributes.PropertyChanged, AddressOf OnAttributesPropertyChanged
			End If
			_attributes = a
	...
	Private Sub OnAttributesRemoved(ByVal s As Object)
		If Object.Equals(s, _face) Then
			If _attributes IsNot Nothing Then
				RemoveHandler _attributes.PropertyChanged, AddressOf OnAttributesPropertyChanged
			End If
			_attributes = Nothing
