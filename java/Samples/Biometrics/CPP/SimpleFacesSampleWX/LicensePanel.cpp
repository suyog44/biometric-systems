...
namespace Neurotec
{
	namespace Samples
	{
		LicensePanel::LicensePanel(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style, const wxString &name):wxPanel(parent, id, pos, size, style | wxBORDER_SIMPLE, name)
		{
			CreateGUIControls();
		}
