	...
	m_indeterminateColor(0xFF, 0xA5, 0x00)
{
	...
	wxStaticText * textIcaoStatus = new wxStaticText(this, wxID_ANY, wxT("ICAO Status:"), wxDefaultPosition, wxDefaultSize, 0);
	textIcaoStatus->Wrap(-1);
	textIcaoStatus->SetFont( wxFont( wxNORMAL_FONT->GetPointSize() + 2, 70, 90, 92, false, wxEmptyString ) );
	bSizer1->Add( textIcaoStatus, 0, wxALL, 2 );
...
{
	if ((wxString)args.GetPropertyName() == wxT("IcaoWarnings"))
	{
