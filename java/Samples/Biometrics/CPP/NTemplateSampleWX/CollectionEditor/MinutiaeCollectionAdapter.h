#ifndef MINUTIAE_COLLECTION_ADAPTER_H_INCLUDED
#define MINUTIAE_COLLECTION_ADAPTER_H_INCLUDED

#include "CollectionBaseAdapter.h"

namespace Neurotec { namespace Samples { namespace CollectionEditor
{
	class MinutiaeCollectionAdapter : public CollectionBaseAdapter
	{
	public:
		MinutiaeCollectionAdapter(const Neurotec::Biometrics::NFRecord& record);
		~MinutiaeCollectionAdapter();
