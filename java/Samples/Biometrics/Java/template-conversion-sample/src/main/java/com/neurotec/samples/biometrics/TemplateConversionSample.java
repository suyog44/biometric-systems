...
public final class TemplateConversionSample implements PropertyChangeListener {
	...
	public static void main(String[] args) {
		...
		TemplateConversionSample sample = new TemplateConversionSample();
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					frame.setTitle("Neurotechnology Template Conversion Sample");
	...
	private TemplateConversionSample() {
